<?php
    ...
    $menu_tous_les_rendez_vous = "active";
?>
<!doctype html>
<html lang="fr">
    <head>
    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Vous verrez ici la liste de tous les rendez-vous.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="rendez-vous-add.php"><button class="btn btn-primary mr-2">Ajouter un nouveau rendez-vous</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var rendez_vousDataTable = $('#data_table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"rendez-vous-fetch-details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur le rendez-vous");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    text: 'Etes-vous sûre de vouloir supprimer ce rendez-vous ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            ...
                            {
                                if(data) {
                                    swal('Effectué','Le rendez-vous a été supprimé.', 'success');
                                }
                                else{
                                    swal('Échoué','La suppression a échouée.', 'error');
                                }

                                rendez_vousDataTable.ajax.reload();
                            }
                        });
