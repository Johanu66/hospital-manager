<?php
    ...
    $menu_tous_les_departements = "active";
?>
<!doctype html>
<html class="no-js" lang="en">
    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Vous verrez ici la liste de tous les services.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="departements_add.php"><button class="btn btn-primary mr-2">Ajouter un nouveau service</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var departementsDataTable = $('#data_table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"departements_fetch_details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur le service");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    text: 'Etes-vous sûre de vouloir supprimer ce service ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
