<?php
    ...
    {	// changer les colonnes à rechercher
        $query .= "AND ( CONCAT(id_prestation, '') LIKE '%".$_POST['search']['value']."%' ";
        ...
        $query .= "OR notes_prestation LIKE '%".$_POST['search']['value']."%' ";
        $query .= "OR CONCAT(statut_prestation, '') LIKE '%".$_POST['search']['value']."%' ) ";
    }
