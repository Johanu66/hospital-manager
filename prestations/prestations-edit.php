                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            if(isset($_POST['submit'])){
                                if(!empty($_POST['nom']) && !empty($_POST['departement']) && !empty($_POST['montant']) && isset($_POST['id_prestation'])){
                                    $id_prestation = htmlspecialchars($_POST['id_prestation']);
                                    ...
                                    ?>
                                    <script>
                                        window.location.replace("prestations.php?success=La prestation <?php echo $nom; ?> a été modifiée.");
                                    </script>
                                    <?php
                                }
                                else{
                            ...
                            if(isset($_GET['id']) && !empty($_GET['id'])){
                                $statement = $bdd->prepare("SELECT * FROM prestation INNER JOIN departement ON id_departement = id_departement_fk_prestation WHERE id_prestation = ?");
                            ...
                            <div class="m-auto col-md-11">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="text" name="id_prestation" value="<?php if(isset($_POST['id_prestation'])){ echo($_POST['id_prestation']); }else if(isset($old_value)){ echo($old_value['id_prestation']); }  ?>" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="exampleInputName1">Nom</label>
                                                            <input type="text" name="nom" value="<?php if(isset($_POST['nom'])){ echo($_POST['nom']); }else if(isset($old_value['nom_prestation'])){ echo($old_value['nom_prestation']); } ?>" class="form-control" id="exampleInputName1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="departement" class="form-control" id="exampleSelectGender">
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    else if(isset($old_value['id_departement'])){
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="montant" value="<?php if(isset($_POST['montant'])){ echo($_POST['montant']); }else if(isset($old_value['montant_prestation'])){ echo($old_value['montant_prestation']); } ?>" class="form-control" id="exampleInputName1">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Notes</label>
                                                    <textarea class="form-control" name="notes" id="exampleTextarea1" rows="4"><?php if(isset($_POST['notes'])){ echo($_POST['notes']); }else if(isset($old_value['notes_prestation'])){ echo($old_value['notes_prestation']); } ?></textarea>
                                                </div>
