<?php
    ...
    if (isset($_GET['id'])) {
        // Mettre à jour le statut de la prestation à 'Actif'
        update("prestation", [
            "statut_prestation" => "Actif"
        ...
        header("Location: prestations.php?success=La prestation " . $result['nom_prestation'] . " est désormais active.");
    }
?>
