...
<?php include("../parts/head.php"); ?>
    ...
    <body>
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Liste des magasins</h5>
                                            <span>Vous verrez ici la liste de tous les magasins.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Tous les magasins</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="magasins-add.php"><button class="btn btn-primary mr-2">Ajouter un nouveau magasin</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var magasinsDataTable = $('#data_table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"magasins-fetch-details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur le magasin");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    text: 'Etes-vous sûre de vouloir supprimer ce magasin ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
