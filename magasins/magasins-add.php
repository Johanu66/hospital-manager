                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Ajout de magasin</h5>
                                            <span>En remplissant ce formulaire, vous pouvez ajouter un nouveau magasin</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
            ...
            if(isset($_POST['submit'])){
                if(!empty($_POST['nom'])){
                    ...
                    insert("magasin",[
                        ...
                        "desc_magasin" => $desc,
                        "photo_magasin" => $photo,
                        "date_create_magasin" => $now->format('Y-m-d H:i:s'),
                        "user_create_magasin" => $_SESSION['nom']." ".$_SESSION['prenom'],
                    ...
                    ?>
                    <script>
                        window.location.replace("magasins.php?success=Le magasin <?php echo $nom; ?> a été enregistré.");
                    </script>
                    <?php
                }
                else{
        ...
        ?>
                        ...
                        <div class="row">
                            <div class="m-auto col-md-11">
                                    <div class="card">
                                        <div class="card-header"><h3>Formulaire d'ajout de magasin</h3></div>
                                        <div class="card-body">
