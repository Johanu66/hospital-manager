    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Vous verrez ici la liste de tous les docteurs.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Tous les docteurs</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="docteurs_add.php"><button class="btn btn-primary mr-2">Ajouter un nouveau docteur</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"docteurs_fetch_details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur le docteur");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                var id = $(this).attr('id');
                swal({
                    title: 'Suppression de docteur',
                    text: 'Etes-vous sûre de vouloir supprimer ce docteur ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            ...
                            {
                                if(data) {
                                    swal('Effectué','Le docteur '+data+' a été supprimé.', 'success');
                                }
                                else{
                                    swal('Échoué','La suppression a échouée.', 'error');
                                }

                                docteursDataTable.ajax.reload();
                            }
                        });
