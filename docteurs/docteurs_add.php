                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Ajout de nouveau docteur</h5>
                                            <span>En remplissant ce formulaire, vous pouvez enregistrer un nouveau docteur</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Ajouter docteur</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
            ...
            if(isset($_POST['submit'])){
                if(!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['email']) && !empty($_POST['sexe']) && !empty($_POST['specialite']) && !empty($_POST['departement']) && !empty($_POST['date_prise_fonction']) && !empty($_POST['adresse']) && !empty($_POST['tel']) && !empty($_POST['date_naissance'])){
                    ...
                    insert("docteur",[
                        ...
                        "notes_docteur" => $notes,
                        "id_personne_fk_docteur" => $row['last_id_personne'],
                    ...
                    ?>
                    <script>
                        window.location.replace("docteurs.php?success=Le docteur <?php echo $nom." ".$prenom; ?> a été enregistré.");
                    </script>
                    <?php
                }
                else{
        ...
        ?>
                        ...
                        <div class="row">
                            <div class="m-auto col-md-11">
                                    <div class="card">
                                        <div class="card-header"><h3>Formulaire d'ajout de docteur</h3></div>
                                        <div class="card-body">
