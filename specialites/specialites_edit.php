                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                            if(isset($_POST['submit'])){
                                if(!empty($_POST['nom']) && !empty($_POST['id_specialite'])){
                                    $id_specialite = htmlspecialchars($_POST['id_specialite']);
                                    ...
                                    if($find){
                                        ...
                                        ?>
                                        <script>
                                            window.location.replace("specialites.php?success=La spécialité <?php echo $nom; ?> a été modifiée.");
                                        </script>
                                        <?php
                                    }
                                }
                            ...
                            <div class="m-auto col-md-11">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="text" name="id_specialite" value="<?php if(isset($_POST['id_specialite'])){ echo($_POST['id_specialite']); }else if(isset($old_value)){ echo($old_value['id_specialite']); }  ?>" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputName1">Nom</label>
                                                            <input type="text" name="nom" value="<?php if(isset($_POST['nom'])){ echo($_POST['nom']); }else if(isset($old_value)){ echo($old_value['nom_specialite']); }  ?>" class="form-control" id="exampleInputName1">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="desc" value="<?php if(isset($_POST['desc'])){ echo($_POST['desc']); }else if(isset($old_value)){ echo($old_value['desc_specialite']); }  ?>" class="form-control" id="exampleInputName1">
                                                        </div>
                                                    </div>
                                                </div>
