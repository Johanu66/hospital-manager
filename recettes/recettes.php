<?php
    ...
    $menu_toutes_les_recettes = "active";
?>
<!doctype html>
<html lang="fr">
<?php include("../parts/head.php"); ?>
    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Vous verrez ici la liste de toutes les recettes.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Toutes les recettes</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="recettes-add.php"><button class="btn btn-primary mr-2">Ajouter une nouvelle recette</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var recettesDataTable = $('#data_table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
                    url:"recettes-fetch.php", //changer
                    dataType:"json",
                    type:"POST"
                },
                "columnDefs":[
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"recettes-fetch-details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur la recette");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    text: 'Etes-vous sûre de vouloir supprimer cette recette ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
