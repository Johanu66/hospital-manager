...
<?php include("../parts/head.php"); ?>
    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Vous verrez ici la liste de tous les patients.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="patients_add.php"><button class="btn btn-primary mr-2">Ajouter un nouveau patient</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var patientsDataTable = $('#data_table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"patients_fetch_details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur le patient");
                        $('#details').html(data);
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    ...
                    {
                        $('#modal_view').modal('show');
                        $('.modal-title_view').text("Détails sur le spécialité");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                ...
                swal({
                    ...
                    text: 'Etes-vous sûre de vouloir supprimer ce patient ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            ...
                            {
                                if(data) {
                                    swal('Effectué','Le patient '+data+' a été supprimé.', 'success');
                                }
                                else{
