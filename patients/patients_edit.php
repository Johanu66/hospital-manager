                    ...
                    <div class="container-fluid">
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Modifier un patient</h5>
                                            <span>En remplissant ce formulaire, vous pouvez modifier un patient existant.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Modifier patient</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <?php
                            if(isset($_POST['submit'])){
                                if(!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['email']) && !empty($_POST['sexe']) && !empty($_POST['adresse']) && !empty($_POST['tel']) && !empty($_POST['date_naissance'])){
                                    ...
                                    $statement->execute(array($id_patient));
                                    ...
                                    ?>
                                    <script>
                                        window.location.replace("patients.php?success=Le patient <?php echo $nom." ".$prenom; ?> a été modifié.");
                                    </script>
                                    <?php
                                }
                                else{
                        ...
                        <div class="row">
                            <div class="m-auto col-md-11">
                                    <div class="card">
                                        <div class="card-header"><h3>Formulaire de modification de patient</h3></div>
                                        <div class="card-body">
                                            <form class="forms-sample" enctype="multipart/form-data" action="" method="post">
                                                <input type="text" name="id_patient" value="<?php if(isset($_POST['id_patient'])){ echo($_POST['id_patient']); }else if(isset($old_value)){ echo($old_value['id_patient']); }  ?>" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="notes" id="exampleTextarea1" rows="4"><?php if(isset($_POST['notes'])){ echo($_POST['notes']); }else if(isset($old_value)){ echo($old_value['notes_patient']); } ?></textarea>
                                                </div>
