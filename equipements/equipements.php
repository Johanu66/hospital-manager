<?php
    ...
    $menu_tous_les_equipements = "active";
?>
<!doctype html>
<html lang="fr">
    <head>
    ...
    <body>
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Vous verrez ici la liste de tous les équipements.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Tous les équipements</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <div class="card-header" style="display: flex; justify-content: space-between;">
                                        ...
                                        <?php
                                            if($_SESSION['id_type_compte'] <= 4){
                                                ?>
                                                <a href="equipements-add.php"><button class="btn btn-primary mr-2">Ajouter un nouveau équipement</button></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var equipementsDataTable = $('#data_table').DataTable({
                "processing":true,
                "serverSide":true,
                "order":[],
                "ajax":{
            ...
            $(document).on('click', '.view', function(){
                ...
                $.ajax({
                    url:"equipements-fetch-details.php",
                    method:"POST",
                    ...
                    success:function(data)
                    {
                        ...
                        $('.modal-title_view').text("Détails sur le equipement");
                        $('#details').html(data);
            ...
            $(document).on('click', '.delete', function(){
                var id = $(this).attr('id');
                swal({
                    title: 'Suppression de equipement',
                    text: 'Etes-vous sûre de vouloir supprimer ce equipement ?',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: false,
                })
